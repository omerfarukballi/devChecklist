...
export const TECH_STACKS: Record<ProjectTypeId, TechOption[]> = {
    ...
    'game-unity': [{ id: 'unity', label: 'Unity', recommended: true }, { id: 'csharp', label: 'C#', recommended: true }, { id: 'urp', label: 'URP (Universal Render Pipeline)' }, { id: 'hdrp', label: 'HDRP (High Definition)' }, { id: 'dots', label: 'DOTS / ECS' }, { id: 'addressables', label: 'Addressables' }, { id: 'cinemachine', label: 'Cinemachine' }, { id: 'new-input-system', label: 'New Input System' }],
    'game-godot': [{ id: 'godot', label: 'Godot Engine', recommended: true }, { id: 'gdscript', label: 'GDScript', recommended: true }, { id: 'csharp', label: 'C# (Godot)' }, { id: 'gdextension', label: 'GDExtension (C++)' }],
    'game-unreal': [{ id: 'unreal', label: 'Unreal Engine', recommended: true }, { id: 'cpp', label: 'C++', recommended: true }, { id: 'blueprints', label: 'Blueprints' }, { id: 'lumen', label: 'Lumen GI' }, { id: 'nanite', label: 'Nanite' }, { id: 'enhanced-input', label: 'Enhanced Input System' }, { id: 'gas', label: 'Gameplay Ability System' }],
