...
const s = StyleSheet.create({
    ...
    headerProject: { color: '#3b82f6', fontSize: 11, fontWeight: 'bold', textAlign: 'center', letterSpacing: 0.5, marginBottom: 2 },
    headerTitle: { color: 'white', fontWeight: 'bold', fontSize: 15, textAlign: 'center', textTransform: 'capitalize' },
    headerSubtitle: { color: '#6b7280', fontSize: 11, textAlign: 'center', letterSpacing: 1 },
    ...
    addPhaseBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 20, padding: 16, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(0,120,212,0.35)', borderStyle: 'dashed' },
    ...
    groupLabel: { color: '#9ca3af', fontWeight: 'bold', fontSize: 12, letterSpacing: 2 },
    ...
    promptChip: { backgroundColor: 'rgba(0,120,212,0.1)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6, borderWidth: 1, borderColor: 'rgba(0,120,212,0.2)', flexDirection: 'row', alignItems: 'center' },
    promptChipText: { color: '#3b82f6', fontSize: 11, fontWeight: 'bold', marginLeft: 4 },
    ...
    // Add item
    addItemTrigger: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 16, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(0,120,212,0.3)', borderStyle: 'dashed', marginTop: 8 },
    addItemTriggerText: { color: theme.colors.accent, fontWeight: '600', fontSize: 15 },
    addItemBox: { backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginTop: 8, borderWidth: 1, borderColor: 'rgba(0,120,212,0.3)' },
